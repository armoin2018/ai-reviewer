 ...
 */
export async function readMainInstructions() {
 ...
 */
export async function listClaudeDirectory() {
    const start = Date.now();
    const result = {
        instructions: [],
        personas: [],
 ...
 */
export async function writeClaudeFile(filePath, content) {
    const start = Date.now();
    try {
        validatePath(filePath);
        // Validate content
 ...
 */
export async function deleteClaudeFile(filePath) {
    const start = Date.now();
    try {
        validatePath(filePath);
